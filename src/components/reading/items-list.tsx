...
const ReadingItem: React.FC<{item: any, index: number}> = ({item, index}) => {
  return (
    <Grid item container sx={{flexDirection: {xs: "row", sm: index %2 === 0? "row-reverse" :"row", minHeight: "650px"}, justifyContent: "space-between"}}>
      <Grid item xs={12} sm={5} sx={{height: "650px", alignItems: "center"}}>
